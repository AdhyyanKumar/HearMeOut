...
export default function TranscriptDisplay() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-slate-100 flex flex-col items-center p-8">
      <div className={`transition-all duration-700 ease-in-out ${isRecording ? 'mt-8' : 'mt-[30vh]'}`}>
        <Button
      ...
      <div className={`w-full max-w-7xl mt-12 grid grid-cols-1 md:grid-cols-2 gap-6 transition-all duration-700 ${
        ...
        <div className="transform transition-all duration-700 ease-out" style={{
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl p-6 border border-slate-200 h-[600px] flex flex-col">
            <div className="flex items-center gap-3 mb-4 pb-4 border-b border-slate-200">
              <div className="w-3 h-3 rounded-full bg-blue-500 animate-pulse" />
              <h2 className="text-xl font-semibold text-slate-800">HearMeOut</h2>
            </div>
        ...
        <div className="transform transition-all duration-700 ease-out delay-100" style={{
          transform: isRecording ? 'translateX(0)' : 'translateX(100px)',
        }}>
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl p-6 border border-slate-200 h-[600px] flex flex-col">
            <div className="flex items-center gap-3 mb-4 pb-4 border-b border-slate-200">
